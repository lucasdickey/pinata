...
window.PINATA = {
  ...
  "decisions": [
    ...
    },
    {
      ...
      "date": "2026-09-10",
      "phase": "wrap",
      "title": "Close out the descoped milestone: reconcile every narrative document to what actually shipped, and fix repository hygiene, with no application code changes",
      "origin": "user-directed",
      "status": "accepted",
      ...
      "decision": "Reconcile the documents to the shipped state without touching application code: milestone statuses and per-bullet shipped/deferred markers in docs/MILESTONES.md; a README status section that says plainly what the build does, what it does not do yet, and that the product is editor-only today; docs/NEXT.md filled in with the cut list, an ordered would-build-next list, and the known weaknesses; build-status notes plus inline deferral markers in docs/REQUIREMENTS.md, docs/ARCHITECTURE.md, and docs/EVALS.md; a session-log section recording the review findings. Move the root PNG to docs/brand/ and add a root .nvmrc pinning Node 24. Regenerate the decision artifacts.",
      "alternatives": [
        {
          "option": "Leave the documents as they were until after the live pins checkpoint",
          "why_not": "The checkpoint may produce more fixes, but the documents were already wrong about what exists today, and a reviewer reading the repository now would be misled."
        },
        {
          "option": "Rewrite the requirements and architecture documents to remove the deferred scope",
          "why_not": "D051's consequence is that those sections describe the vision, not current work. Removing them would erase the design that the schema and boundary catalog already implement; marking them is honest and cheaper."
        },
        {
          "option": "Fix the npm audit findings and the dependency line in the same pass",
          "why_not": "That is a code and lockfile change. The direction for this pass was documentation and hygiene only."
        }
      ],
      "rationale": "The human directed the closeout and the hygiene items explicitly and bounded them to no code changes. Every edit is a statement of fact about what shipped, sourced from the decision log, the session log, the production smoke, and a fresh run of the fast half of the gate.",
      "consequences": [
      ...
      "transcript": {
        "request": "do the docs closeout and the hygiene items, no code changes."
      },
      "artifacts": [
        {
          "type": "file",
          "path": "docs/MILESTONES.md",
          "caption": "Milestone statuses and per-bullet shipped/deferred markers."
        },
        {
          "type": "file",
          "path": "docs/NEXT.md",
          "caption": "Cut list, ordered next steps, and known weaknesses."
        },
        {
          "type": "file",
          "path": "README.md",
          "caption": "Status section reconciled to the shipped build."
        }
      ],
      "supersedes": null,
      "superseded_by": null
    },
    {
      ...
      "alternatives": [
        ...
        {
          "option": "Keep it deferred",
          "why_not": "The human wants the product usable with friends after the assignment, and this is the one feature that makes it so."
        }
      ],
      "rationale": "The human directed the stream, its priority relative to the demo, and the branch-and-later-PR shape. This is a bounded exception to D010, not a reversal: main keeps commit-straight-to-main with the gate before every commit, and the branch carries the same gate.",
      "consequences": [
    ...
    },
    {
      ...
      "transcript": {
        "request": "turn off SSO protection so founders can actually open links"
      },
      "artifacts": [
        {
          "type": "file",
          "path": "scripts/production-smoke.mjs",
          "caption": "Check 1 inverted: anonymous reachability, the sign-in prompt, and a bounded anonymous denial are asserted together."
        },
        {
          "type": "file",
          "path": "e2e/production-smoke.spec.ts",
          "caption": "The former SSO-wall test now asserts the application is the wall."
        },
        {
          "type": "file",
          "path": "README.md",
          "caption": "Deployment section and known weaknesses updated to the public posture."
        }
      ],
      "supersedes": null,
      "superseded_by": null
