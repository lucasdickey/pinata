// POST /api/captures/[captureId]/annotations/[annotationId]/resolve — mark
// one pin resolved (D075). Either role; the change writes a `status` thread
...
export const POST = pinFeedbackHandler("resolve");
